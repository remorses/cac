...
After completing this process you can earn 20% from all plugins sales coming from your templates sales. Your customers will benefit too! They will be able to rewrite the template content faster and more easily, saving them time.
...
> Includes 20% discount code for the Migrate Framer plugin
