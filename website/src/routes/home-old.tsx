...
import FeatureListFramerComponent from '../framer-old/feature-list'
import FooterFramerComponent from '../framer-old/footer'
import HeroFramerComponent from '../framer-old/hero'
import NavFramerComponent from '../framer-old/nav'
import PricingBannerFramerComponent from '../framer-old/pricing-banner'
