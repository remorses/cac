...
fontStore4.loadFonts(['GF;Space Grotesk-700',],);
var fonts5 = [{
  family: 'Space Grotesk',
  source: 'google',
  style: 'normal',
...
var serializationHash2 = 'framer-k2Q04';
...
var getProps2 = ({ framerUrl, height, id, width, ...props },) => {
  var _humanReadableVariantMap_props_variant, _ref;
  return {
    ...props,
    Dm4Edjd64: framerUrl !== null && framerUrl !== void 0 ? framerUrl : props.Dm4Edjd64,
    variant:
      (_ref =
...
var Component2 = /* @__PURE__ */ React2.forwardRef(function (props, ref,) {
  ...
  const {
    ...
    setVariant,
    variants,
  } = useVariantState2({ cycleOrder: cycleOrder2, defaultVariant: 'FZPxxJjOq', variant, variantClassNames: variantClassNames2, },);
            ...
            /* @__PURE__ */ _jsx2(ComponentViewportProvider2, {
              ...
              children: /* @__PURE__ */ _jsx2(motion2.div, {
                ...
                children: /* @__PURE__ */ _jsx2(stdin_default2, {
                  cASqLqJU3: false,
                  CUE0ztma1: 'Migrate your website wiht AI. Save days of work and thousand of dollars.',
                  height: '100%',
                  id: 'WrsYPAnA5',
                  layoutId: 'WrsYPAnA5',
...
var css7 = [
  '@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }',
  '.framer-k2Q04.framer-1378plg, .framer-k2Q04 .framer-1378plg { display: block; }',
  '.framer-k2Q04.framer-1usrhsu { align-content: center; align-items: center; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 32px; height: min-content; justify-content: center; overflow: hidden; padding: 140px 0px 140px 0px; position: relative; width: 1140px; }',
  '.framer-k2Q04 .framer-1a199pe-container { flex: none; height: auto; position: relative; width: 56%; }',
  '.framer-k2Q04 .framer-10e2ga6 { flex: none; height: auto; position: relative; white-space: pre; width: auto; }',
  '.framer-k2Q04 .framer-yhwl67-container { flex: none; height: auto; position: relative; width: auto; }',
  '.framer-k2Q04 .framer-15iblgi { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 243px; justify-content: center; left: 0px; overflow: hidden; padding: 0px; position: absolute; top: 18px; width: 16%; z-index: 1; }',
  '.framer-k2Q04 .framer-qtiat9 { align-content: center; align-items: center; bottom: 57px; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 243px; justify-content: center; overflow: hidden; padding: 0px; position: absolute; right: 0px; width: 16%; z-index: 1; }',
  '@supports (background: -webkit-named-image(i)) and (not (font-palette:dark)) { .framer-k2Q04.framer-1usrhsu, .framer-k2Q04 .framer-15iblgi, .framer-k2Q04 .framer-qtiat9 { gap: 0px; } .framer-k2Q04.framer-1usrhsu > * { margin: 0px; margin-bottom: calc(32px / 2); margin-top: calc(32px / 2); } .framer-k2Q04.framer-1usrhsu > :first-child { margin-top: 0px; } .framer-k2Q04.framer-1usrhsu > :last-child { margin-bottom: 0px; } .framer-k2Q04 .framer-15iblgi > *, .framer-k2Q04 .framer-qtiat9 > * { margin: 0px; margin-left: calc(10px / 2); margin-right: calc(10px / 2); } .framer-k2Q04 .framer-15iblgi > :first-child, .framer-k2Q04 .framer-qtiat9 > :first-child { margin-left: 0px; } .framer-k2Q04 .framer-15iblgi > :last-child, .framer-k2Q04 .framer-qtiat9 > :last-child { margin-right: 0px; } }',
  '.framer-k2Q04.framer-v-sitpyi.framer-1usrhsu { padding: 100px 0px 100px 0px; width: 992px; }',
  '.framer-k2Q04.framer-v-sitpyi .framer-1a199pe-container { width: 53%; }',
  '.framer-k2Q04.framer-v-sitpyi .framer-15iblgi { top: 0px; width: 16%; }',
  '.framer-k2Q04.framer-v-sitpyi .framer-qtiat9 { bottom: 0px; width: 16%; }',
  '.framer-k2Q04.framer-v-1ybeht9.framer-1usrhsu { padding: 80px 0px 80px 0px; width: 708px; }',
  '.framer-k2Q04.framer-v-1ybeht9 .framer-1a199pe-container { width: 57%; }',
  '.framer-k2Q04.framer-v-1ybeht9 .framer-15iblgi { height: 170px; top: 0px; width: 18%; }',
  '.framer-k2Q04.framer-v-1ybeht9 .framer-qtiat9 { bottom: 0px; height: 170px; width: 18%; }',
  '.framer-k2Q04.framer-v-7efl8s.framer-1usrhsu { padding: 60px 0px 60px 0px; width: 350px; }',
...
FramerFF233TYmj.defaultProps = { height: 650, width: 1140, };
addPropertyControls2(FramerFF233TYmj, {
  ...
  Dm4Edjd64: { title: 'framerUrl', type: ControlType2.Link, },
},);
