/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env preview` (hash: c4f8ea144c85bc7d21a0b91d5a45e450)
// Runtime types generated with workerd@1.20251001.0 2025-07-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "McpTunnel";
	}
	interface Env {
		SESSION_KV: KVNamespace;
		STAGE: "production" | "preview";
		WEBSITE_URL: "https://unframer.co" | "https://preview.unframer.co";
		MCP_TUNNEL: DurableObjectNamespace<import("./src/worker").McpTunnel>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STAGE" | "WEBSITE_URL">> {}
}
declare module "*.md" {
	const value: string;
